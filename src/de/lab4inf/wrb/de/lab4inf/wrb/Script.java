...
public interface Script {
	 ...
	 *             in case of an unknown function
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             in case of an unknown variable
	 */
	...
	/**
	 * Parse the given String into an AST and evaluate the result via the tree
	 * walker.
	 * 
	 * @param definition
	 *            for the AST as String
	 * @return the result of the parsed evaluation
	 * @throws RecognitionException
	 *             in case of a parse error
	 * @throws IllegalArgumentException
	 *             in case of an unknown variables or functions
	 */

	double parse(final String definition) throws RecognitionException, IllegalArgumentException;

	/**
	 * Parse the given InputStream into an AST and evaluate the result via the
	 * tree walker.
	 * 
	 * @param defStream
	 *            for the AST as InputStream
	 * @return the result of the parsed evaluation
	 * @throws RecognitionException
	 *             in case of a parse error
	 * @throws IOException
